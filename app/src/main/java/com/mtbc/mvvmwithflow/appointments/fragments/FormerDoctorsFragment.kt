...
import com.mtbc.mvvmwithflow.databinding.FragmentFormerDoctorsBinding
import com.mtbc.mvvmwithflow.model.Doctor

class FormerDoctorsFragment : Fragment() {
    private lateinit var binding: FragmentFormerDoctorsBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        // Inflate the layout for this fragment
        binding =  FragmentFormerDoctorsBinding.inflate(layoutInflater, container, false)
        setAllDoctors()
        return binding.root
    }
    ...
    private fun setAllDoctors() {
        ...
        binding.rvFormerDoctors.adapter = ActiveFormerDoctorsAdapers(doctorList,requireContext())
    }
