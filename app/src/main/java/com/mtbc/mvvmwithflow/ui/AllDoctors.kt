...
import com.mtbc.mvvmwithflow.Adapter.AllDoctorsAdapers
import com.mtbc.mvvmwithflow.Adapter.TabPagerAdapter
import com.mtbc.mvvmwithflow.databinding.ActivityAllDoctorsBinding
import com.mtbc.mvvmwithflow.model.Doctor

class AllDoctors : AppCompatActivity() {
    ...
    private fun setUpTabs() {
        ...
        binding.viewPager.adapter = TabPagerAdapter(this,"Doctors")
    ...
    private fun setAllDoctors() {
        ...
        binding.rvDoctorsDetails.adapter = AllDoctorsAdapers(doctorList, applicationContext)
        binding.tvActiveDoctors.text = "${doctorList.size} Active Doctors"
    }
}